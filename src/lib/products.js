...
const croissantAlmendraViennoiseries = {
    name: 'CROISSANT ALMENDRA',
    description: [
        'Croissant relleno con celestial crema de almendras y almíbar.',
...
const croissantQuesoGruyereViennoiseries = {
    name: 'CROISSANT DE QUESO GRUYERE',
    description: [
        'Croissant relleno de mucho queso gruyere.',
...
const painAuChocolatViennoiseries = {
...
const croissantViennoiseries = {
    name: 'CROISSANT',
    description: [
        'Un ícono de Francia.',
        'Masa de hojaldre hecha 100% con harina Gruau Rouge francesa.',
...
const rollJamonGruyereViennoiseries = {
    name: 'ROLL DE JAMÓN Y GRUYERE',
    description: [
...
const croissantBicolorNutellaViennoiseries = {
    name: 'CROISSANT BICOLOR C/NUTELLA CASERA',
    description: [
        'Croissant en dos colores cubierto de almíbar.',
...
const painAuChocolatAlmendraViennoiseries = {
...
const painAuxRaisinsViennoiseries = {
...
const briocheDulceDeLecheViennoiseries = {
    name: 'BRIOCHE DULCE DE LECHE',
    description: [
        'Inspirado en la receta original del Chef Patissier Antonio Bachour.',
...
const briocheMousseChocolateViennoiseries = {
    name: 'BRIOCHE DE MOUSSE DE CHOCOLATE',
    description: [
...
const kouignAmannViennoiseries = {
    name: 'KOUIGN-AMANN (x2)',
    description: [
        'Difícil de pronunciar, más difícil comer sólo uno.',
...
const croissantBicolorFrutosRojosViennoiseries = {
    name: 'CROISSANT BICOLOR DE FRUTOS ROJOS',
    description: [
...
const briocheSucreeViennoiseries = {
    name: 'BRIOCHE SUCRÉE',
    description: [
        'Tan tradicional como sencillo y delicioso.',
...
const briocheCanelaFrostingLimonViennoiseries = {
    name: 'BRIOCHE DE CANELA CON FROSTING DE LIMÓN',
    description: [
...
const cuboPistachoViennoiseries = {
    name: 'CUBO PISTACHO',
    description: [
...
const baguetteGruyereHierbasPanes = {
    name: 'BAGUETTE GRUYERE Y HIERBAS',
    description: [
...
const panCampoPanes = {
    name: 'PAN DE CAMPO',
    description: [
        'El preferido del panadero. Harina de tradition francesa, masa madre, un toque de harina integral y otro de aceite de oliva en la masa y para recubrirlo.',
        'Junto con el horno de piso de piedra con cámara de vapor, el oliva le da ese espectacular color dorado a la corteza crujiente.',
...
const panIntegralSemillasPanes = {
    name: 'PAN DE MOLDE INTEGRAL CON SEMILLAS',
    description: [
...
export let panes = [
    ...
    panCampoPanes,
    bagguetteSemillasPanes,
    panIntegralSemillasPanes,
    panMarselles,
    panMolde,
    panIntegral,
    panCampagne,
...
const tartaletaLimonPatisserie = {
...
const tartaletaFrutillaPatisserie = {
...
const milhojasVainillaPatisserie = {
    name: 'Milhojas de Vainilla (6 PERSONAS)',
    description: [
...
const tartaletaManzanaPatisserie = {
...
const chouxVainillaPatisserie = {
    name: 'Choux de Vainilla',
    description: [
...
const tartaletaFrutosRojosPatisserie = {
...
const quicheQuesoCabraAlmuerzos = {
    name: 'Quiche Queso de cabra',
    description: [
...
const tartinePaltaAlmuerzos = {
    name: 'Tartine de Palta',
    description: [
...
const tartineJamonCrudoAlmuerzos = {
    name: 'Tartine de jamón crudo',
    description: [
...
const sandwichEntrecoteAlmuerzos = {
    name: 'Sandwich Entrecôte',
    description: [
...
const croissantSalmonAlmuerzos = {
...
const sandwichBondiolaAlmuerzos = {
    name: 'Sandwich Bondiola',
    description: [
...
export let almuerzos = [
    ...
    tartineJamonCrudoAlmuerzos,
    sandwichEntrecoteAlmuerzos,
    croissantSalmonAlmuerzos,
    sandwichBondiolaAlmuerzos
];
...
export let viennoiseries = [
    ...
    croissantViennoiseries,
    rollJamonGruyereViennoiseries,
    croissantBicolorNutellaViennoiseries,
    painAuChocolatAlmendraViennoiseries,
    painSuisseViennoiseries,
    painAuxRaisinsViennoiseries,
    briocheDulceDeLecheViennoiseries,
    briocheMousseChocolateViennoiseries,
    kouignAmannViennoiseries,
    croissantBicolorFrutosRojosViennoiseries,
    briocheSucreeViennoiseries,
    briocheCanelaFrostingLimonViennoiseries,
    cuboPistachoViennoiseries
];
...
export let patisserie = [
    ...
    tartaletaFrutillaPatisserie,
    milhojasVainillaPatisserie,
    tartaletaManzanaPatisserie,
    chouxVainillaPatisserie,
